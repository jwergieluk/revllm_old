...
class VisualizeQAndA():
    ...
    def _prep_for_visualization(self, token_to_explain_index:int=None):
        ...
        for i in range(self.model.config.num_hidden_layers):
            ...
            self.layer_attrs_start.append(summarize_attributions(self.layer_attributions_start).cpu().detach().tolist())
            self.layer_attrs_end.append(summarize_attributions(self.layer_attributions_end).cpu().detach().tolist())
